	...
	$.ajax({
		...
		success: function(data){
			...
			if(response.accountExists){
				location.href = `/pay_redirect.php/=?sum=${curComplectCost}&d_type=COMPLECT&serverid=${serverId}&d_complect=${curComplectName}&account=${urlDecode(accountName)}&desc=Покупка%20набора%20RAGE`;
			} else {
